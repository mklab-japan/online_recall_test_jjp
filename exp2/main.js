...
const learningFillerFirstTrial = {
    type: 'html-keyboard-response',
    stimulus: jsPsych.timelineVariable('item'),
    trial_duration: 7 * displayTime,
    choices: jsPsych.NO_KEYS,
...
const learningPhaseFillerFirst = {
    timeline: [fixation, learningFillerFirstTrial],
    timeline_variables: fillerFirstItemList,
    data: {
        phase: 'LearningFiller'
    }
}

const learningFillerSecondTrial = {
    type: 'html-keyboard-response',
    stimulus: jsPsych.timelineVariable('item'),
    trial_duration: 7 * displayTime,
    choices: jsPsych.NO_KEYS,
...
const learningPhaseFillerSecond = {
    timeline: [fixation, learningFillerSecondTrial],
    timeline_variables: fillerSecondItemList,
    data: {
        phase: 'LearningFiller'
    }
}
...
//スマートフォン以外
    ...
    timeline.push(learningPhaseFillerFirst);
    timeline.push(learningPhase);
    timeline.push(learningPhaseFillerSecond);
